from params import FileParams, PageParams
...
class FirefoxDriver(object):
    ...
    def setup(self):
        driver = webdriver.Firefox(firefox_profile=self.profile(),
                                   executable_path=f"{FileParams.drivers_dir}/geckodriver.exe",
                                   service_log_path=f"{FileParams.drivers_dir}//geckodriver.log")
