...
from app_4_website.pty_oprtn_cd_clssfctn.utils import PtyOprtnClssfctnCdUtils
from app_4_website.pty_oprtn_cd_clssfctn.forms import PtyOprtnCdClssfctnForm
from app_4_website.pty.utils import Pty
from app_4_website.common.utils import redirect_url
from app_4_website.dictionaries.utils import DictTrnsctnSctgUtils, DictOperationTpMapUtils
